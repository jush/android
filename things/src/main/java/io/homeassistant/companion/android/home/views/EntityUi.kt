...
private const val TAG = "EntityUi"
@Composable
fun EntityUi(
    entity: Entity<*>,
    ...
    Log.d(
        TAG,
        "EntityUi() called with: entity = $entity, onEntityClicked = $onEntityClicked, isHapticEnabled = $isHapticEnabled, isToastEnabled = $isToastEnabled"
    )
